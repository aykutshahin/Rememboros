    ...
    public class CharacterMotor2D : BaseMotor2D
    {
        ...
        private void horizontalCollision(ref Vector3 velocity)
        {
            ...
            for (int i = 0; i < m_Raycaster.HorizontalRayCount; i++)
            {
                ...
                RaycastHit2D hit = Physics2D.Raycast(rayOrigin, Vector2.right * directionX, rayLength, m_Raycaster.CollisionLayer | m_Raycaster.enemyLayer);
        ...
        private void verticalCollision(ref Vector3 velocity)
        {
            ...
            for (int i = 0; i < m_Raycaster.VerticalRayCount; i++)
            {
                ...
                RaycastHit2D hit = Physics2D.Raycast(rayOrigin, Vector2.up * directionY, rayLength, m_Raycaster.CollisionLayer | m_Raycaster.enemyLayer);
        ...
        void descendSlope(ref Vector3 velocity)
        {
            ...
            RaycastHit2D hit = Physics2D.Raycast(rayOrigin, -Vector2.up, Mathf.Infinity, m_Raycaster.CollisionLayer | m_Raycaster.enemyLayer);
